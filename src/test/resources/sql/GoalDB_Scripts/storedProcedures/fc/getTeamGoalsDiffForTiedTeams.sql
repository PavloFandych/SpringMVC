-- this function calculates goals difference only if all clubs involved have played each other twice

DELIMITER $$
DROP FUNCTION IF exists getTeamGoalsDiffForTiedTeams;$$
 
CREATE FUNCTION getTeamGoalsDiffForTiedTeams(teamCode VARCHAR(6),
