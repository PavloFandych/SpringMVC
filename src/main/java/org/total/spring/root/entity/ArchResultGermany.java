...
public final class ArchResultGermany implements Serializable {
    ...
    public ArchResultGermany() {
    }

    public ArchResultGermany(Team hostTeam,
                             Team guestTeam,
                             byte goalsByHost,
                             byte goalsByGuest) {
    ...
    @JoinColumn(name = "tournamentId",
            nullable = false,
            foreignKey = @ForeignKey(name = "FK_ArchResultGermany_tournamentId")
    )
    @JsonIgnore
    ...
    @JoinColumn(name = "seasonId",
            nullable = false,
            foreignKey = @ForeignKey(name = "FK_ArchResultGermany_seasonId")
    )
    @JsonIgnore
    ...
    @JoinColumn(name = "hostTeamId",
            nullable = false,
            foreignKey = @ForeignKey(name = "FK_ArchResultGermany_hostTeamId")
    )
    ...
    @JoinColumn(name = "guestTeamId",
            nullable = false,
            foreignKey = @ForeignKey(name = "FK_ArchResultGermany_guestTeamId")
    )
    ...
    public boolean equals(Object o) {
        ...
        ArchResultGermany result = (ArchResultGermany) o;
